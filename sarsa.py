...
class Sarsa_Learner(object):
    ...
    #CHANGES HAVE BEEN MADE HERE TO CHANGE FROM Q-LEARNING TO SARSA
...
# Use the VideoRecorder to evalaute the agent and record video
gym_monitor_path = "./gym_monitor_sarsa.mp4"
